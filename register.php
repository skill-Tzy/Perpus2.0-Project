...
<html lang="en">
  ...
  <body background="img/page-background.png">
    <div class="container">
      ...
      <form  action="proses.php" method="POST" class="form-signin" enctype="multipart/form-data">
        <center><h2 class="form-signin-heading"><span class="glyphicon glyphicon-th-large"></span> PerPusWeb </h2></center>
        <div class="input-group">
         <span class="input-group-addon"><i class="glyphicon glyphicon-globe"></i></span>
         <input name="user_id" type="text" id="user_id" class="form-control" placeholder="User ID | Tidak perlu di isi" autofocus="on" readonly="readonly" />
         </div>
        <div class="input-group" style="margin-top: 5px;">
         <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
         <input type="text" id="username" name="fullname" class="form-control" placeholder="Fullname" required>
         </div>
        <div class="input-group" style="margin-top: 5px;">
         <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
         <input type="text" id="password" name="username" class="form-control" placeholder="Username" required>
         </div>
        <div class="input-group" style="margin-top: 5px;">
        ...
        <div class="input-group" style="margin-top: 5px;">
         <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
         <input type="text" placeholder="Confirm Password" name="cpassword" id="cpassword" class="form-control" value="<?php echo $_POST['cpassword']; ?>" required>
         </div>
        <div class="input-group" style="margin-top: 5px;">
         <span class="input-group-addon"><b>Foto</b></span>
         <input class="form-control" name="nama_file" id="nama_file" type="file" />
         </div>
        <br />
        <button type="submit" value="Simpan" class="btn btn-lg btn-primary btn-block">Register</button>
        <center><h5 class="form-signin">Udah punya Akun? buruan<a href="www.php"> Login</a></h5></center>
      </form>
